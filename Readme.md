...
---------------------
 ...
 ```
 ---------------------
 - gws.getCalendar(): Returns calendar events for the main calendar
 ```
...
Events generated by the modules are as follows
 ...
 - gws.on('error',function(err){}): general error notification
 - gws.on('response', function(res){}): notify that the soap client received a response from server.
